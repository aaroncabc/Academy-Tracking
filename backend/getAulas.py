...
def obtener_aulas(): 
    ...
    try:
        lista = session.execute(text("SELECT  aula.grupo,aula.grado,aula.gradot,institucion.nombre, aula.id_aula FROM aula INNER JOIN institucion ON (aula.id_institucion = institucion.id_institucion) WHERE año = :año_actual "), {"año_actual": año_actual})
